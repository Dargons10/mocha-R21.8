...
struct clk_duplicate tegra_clk_duplicates[] = {
	...
	/* Generic VI clock lookups for DT-probed devices (dev_name != tegra_vi.0) */
	CLK_DUPLICATE("via.vi.c4bus", NULL, "vi"),
	CLK_DUPLICATE("csi", NULL, "csi"),
	CLK_DUPLICATE("csus", NULL, "csus"),
	CLK_DUPLICATE("vim2_clk", NULL, "vim2_clk"),
	CLK_DUPLICATE("cilab", NULL, "cilab"),
	CLK_DUPLICATE("cilcd", NULL, "cilcd"),
	CLK_DUPLICATE("cile", NULL, "cile"),
